...
htmlhelp_basename = 'invenio-theme_namedoc'
...
latex_documents = [
  (master_doc, 'invenio-theme.tex', u'invenio-theme Documentation',
...
man_pages = [
    (master_doc, 'invenio-theme', u'invenio-theme Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'invenio-theme', u'Invenio Theme Documentation',
   author, 'invenio-theme', 'Invenio standard theme.',
   'Miscellaneous'),
]
